...
function Crossswap({ activeTab }) {
  ...
  const dummyNetworks = [
    {
      name: "Network 1",
      tokens: [
        { name: "Token 1", address: "0x123456789ABCDEF1" },
        { name: "Token 2", address: "0x123456789ABCDEF2" },
        { name: "Token 3", address: "0x123456789ABCDEF3" },
      ],
    },
    {
      name: "Network 2",
      tokens: [
        { name: "Token 4", address: "0x123456789ABCDEF4" },
        { name: "Token 5", address: "0x123456789ABCDEF5" },
        { name: "Token 6", address: "0x123456789ABCDEF6" },
      ],
    },
  ];
  ...
  const filteredTokenList = dummyNetworks.filter(
    (token) =>
